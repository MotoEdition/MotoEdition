...
e.printStackTrace();
   ...
   private static void GetId() throws SQLException {
     ...
     ResultSet.CONCUR_UPDATABLE);
        ...
        ResultSet res = sta.executeQuery("SELECT * FROM Orders3");
...
dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
      ...
      i =Integer.parseInt(a);
       ...
       ResultSet.TYPE_FORWARD_ONLY,
       ResultSet.CONCUR_UPDATABLE);
     //    int count = sta.executeUpdate("CREATE TABLE Orders3(ID INT, Name1 VARCHAR(200)," + "Name2 VARCHAR(200)," + " Telephone VARCHAR(200)," + " Brand VARCHAR(200)," + " Model VARCHAR(200)," + " Problem VARCHAR(600)," + " Time VARCHAR(200)," + " Email VARCHAR(300)," + " Price VARCHAR(30)," + " Status VARCHAR(30))");
        System.out.println("Table created.");
        
        int c = sta.executeUpdate("INSERT INTO Orders3 "+ " (ID, Name1, Name2, Telephone, Brand, Model , Problem, Time, Email, Price, Status)"+ " values (" + i + ",'" + jTextField1.getText() + "','" + jTextField2.getText() +"','" + jTextField3.getText() + "','" + jTextField4.getText() + "','" + jTextField5.getText() + "','" + jTextField6.getText() + "','" + jTextField7.getText() + "','" + jTextField8.getText() + "',' Null " + "','Not Begun')");
        System.out.println("Rows Added");
